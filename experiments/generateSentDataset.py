...
def _process_args():
    ...
    # output path
    parser.add_argument('-out', default='/Users/praveen/work/research/ctgov/output/sentData', help='part-of-speech admitted tag file (default: None)')
...
if __name__ == '__main__':
    ...
    log.info('processing clinical trials')
    procs = []
    _worker(nct_ids, corpus_path, args.out, 1)